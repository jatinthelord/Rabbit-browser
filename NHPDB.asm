; Rabbit browser NHP DB made by Jatinthelord 
...
banner      db '================================================',10
            ...
            db '  Rabbit Browser - Your Own SQL',10
            db '  Assembly se bana tera apna Database',10
            db '================================================',10
...
.customers:
    cmp r15, 1              ; Country + City + Zoro lost his way
    je  .cust_cc
    cmp r15, 2              ; Name + Age + Dob yayyy
    je  .cust_na
    ; else all columns
